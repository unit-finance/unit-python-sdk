...
class TransactionResource(BaseResource):
    ...
    def sb_simulate_purchase_transaction(self, request: SimulatePurchaseTransaction) -> Union[UnitResponse[PurchaseTransactionDTO], UnitError]:
        payload = request.to_json_api()
    ...
    def sb_simulate_card_transaction(self, request: SimulateCardTransaction) -> Union[UnitResponse[CardTransactionDTO], UnitError]:
        payload = request.to_json_api()
